...
class Hat:
    ...
    def draw(self, num):
        ...
        so....need replenish colour balls after each experiment
        and seems it need to be the same as the original one...
        '''
...
def experiment(
    ...
    for _ in range(num_experiments):
        ...
        for color in expected_balls:
            #_ cnt >= expected_balls is success result...
